...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'qpoint.type.v1.artifact_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ARTIFACT.fields_by_name['timestamp']._options = None
  _ARTIFACT.fields_by_name['timestamp']._serialized_options = b'\272H\003\310\001\001'
  _ARTIFACT.fields_by_name['connection_id']._options = None
  _ARTIFACT.fields_by_name['connection_id']._serialized_options = b'\272H\003\310\001\001'
  _ARTIFACT.fields_by_name['request_id']._options = None
  _ARTIFACT.fields_by_name['request_id']._serialized_options = b'\272H\003\310\001\001'
  _ARTIFACT.fields_by_name['type']._options = None
  _ARTIFACT.fields_by_name['type']._serialized_options = b'\272H\003\310\001\001'
  _ARTIFACT._serialized_start=142
  _ARTIFACT._serialized_end=505
