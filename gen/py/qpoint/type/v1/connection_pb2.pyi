...
class Connection(_message.Message):
    __slots__ = ["bytes_received", "bytes_sent", "destination", "direction", "endpoint_id", "finalized", "id", "l7_protocol", "labels", "part", "socket_protocol", "source", "system", "tags", "timestamp", "tls_probe_introspected", "tls_probe_types_detected", "tls_version", "vendor_id"]
    class Endpoint(_message.Message):
        __slots__ = ["local", "remote"]
        class Local(_message.Message):
            __slots__ = ["address", "container", "exe", "hostname", "user", "user_id"]
    ...
    class System(_message.Message):
        __slots__ = ["agent", "agent_instance", "hostname"]
