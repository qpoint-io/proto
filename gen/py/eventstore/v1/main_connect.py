...
class EventStoreServiceASGIApplication(ConnectASGIApplication[EventStoreService]):
    def __init__(self, service: EventStoreService | AsyncGenerator[EventStoreService], *, interceptors: Iterable[Interceptor]=(), read_max_bytes: int | None = None) -> None:
        super().__init__(
            service=service,
