...
from qpoint.type.v1 import grpc_request_pb2 as _grpc_request_pb2
...
class Event(_message.Message):
    __slots__ = ["request", "issue", "artifact", "pii_entity", "connection", "database_request", "grpc_request"]
